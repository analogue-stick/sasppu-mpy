...
static const mp_rom_map_elem_t sasppu_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_get_text_size), MP_ROM_PTR(&sasppu_get_text_size_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_HDMA_NOOP), MP_ROM_INT(HDMA_NOOP)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_DISABLE), MP_ROM_INT(HDMA_DISABLE)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_MAINSCREEN_COLOUR), MP_ROM_INT(HDMA_MAIN_STATE_MAINSCREEN_COLOUR)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_SUBSCREEN_COLOUR), MP_ROM_INT(HDMA_MAIN_STATE_SUBSCREEN_COLOUR)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_WINDOW1_LEFT), MP_ROM_INT(HDMA_MAIN_STATE_WINDOW1_LEFT)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_WINDOW1_RIGHT), MP_ROM_INT(HDMA_MAIN_STATE_WINDOW1_RIGHT)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_WINDOW2_LEFT), MP_ROM_INT(HDMA_MAIN_STATE_WINDOW2_LEFT)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_WINDOW2_RIGHT), MP_ROM_INT(HDMA_MAIN_STATE_WINDOW2_RIGHT)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_BGCOL_WINDOWS), MP_ROM_INT(HDMA_MAIN_STATE_BGCOL_WINDOWS)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_MAIN_STATE_FLAGS), MP_ROM_INT(HDMA_MAIN_STATE_FLAGS)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_CMATH_STATE_SCREEN_FADE), MP_ROM_INT(HDMA_CMATH_STATE_SCREEN_FADE)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_CMATH_STATE_FLAGS), MP_ROM_INT(HDMA_CMATH_STATE_FLAGS)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND0_X), MP_ROM_INT(HDMA_BACKGROUND0_X)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND0_Y), MP_ROM_INT(HDMA_BACKGROUND0_Y)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND0_WINDOWS), MP_ROM_INT(HDMA_BACKGROUND0_WINDOWS)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND0_FLAGS), MP_ROM_INT(HDMA_BACKGROUND0_FLAGS)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND1_X), MP_ROM_INT(HDMA_BACKGROUND1_X)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND1_Y), MP_ROM_INT(HDMA_BACKGROUND1_Y)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND1_WINDOWS), MP_ROM_INT(HDMA_BACKGROUND1_WINDOWS)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_BACKGROUND1_FLAGS), MP_ROM_INT(HDMA_BACKGROUND1_FLAGS)},
    {MP_ROM_QSTR(MP_QSTR_HDMA_HDMA_ENABLE), MP_ROM_INT(HDMA_HDMA_ENABLE)},
};
